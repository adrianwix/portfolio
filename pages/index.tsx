...
const Home: React.FC = () => (
	<Container>
		...
		<p className="h2-home">
			Throughout my journey learning to code I acquired the following
			skills.
		</p>
		...
		<Row>
			<Col className="skills" sm={6} md={6} lg={3}>
				...
				<div className="skill">
					<object
						className="skill_icon"
						data="static/icons/javascript.svg"
						type="image/svg+xml"
					/>
					<div className="skill_box">
			...
			<Col className="skills" sm={6} md={6} lg={3}>
				<div className="skill">
					<object
						className="skill_icon"
						data="static/icons/typescript.svg"
						type="image/svg+xml"
					/>
					<div className="skill_box">
		...
		<p className="h2-home mt-5 mb-4">
			Skills which helped me to complete the following projects
		</p>
				...
				<Card className="project">
					...
					<Card.Body>
						...
						<Card.Text className="project_description">
							Current Portfolio developed to put in to practice
							and show most of the knowledge learned so far.
						</Card.Text>
					</Card.Body>
					...
					<Card.Body>
						<Card.Link href="https://github.com/adrianwix/portfolio">
							Github
						</Card.Link>
					</Card.Body>
				</Card>
			...
			<Col md={6}>
				<Card className="project">
					...
					<Card.Body>
						...
						<Card.Text className="project_description">
							Prima Salud is the bigger manufacturer of medical
					...
					<Card.Body>
						<Card.Link href="https://primasalud-laravel.herokuapp.com/">
							Dev Build
						</Card.Link>
					</Card.Body>
				</Card>
		...
		<p className="h2-home mt-5">
			Furthermore many other projects were completed in the
			FreeCodeCamp.com curriculum
		</p>

		<Row>
			<Col lg={6}>
				<div className="fcc-certificate">
					<h3 className="fcc-certificate_name">
						Responsive Web Design
					</h3>
					<p className="fcc-certificate_description">
						Use of HTML and CSS to build websites. Responsive
						developer through CSS Flexbox and Grid
					</p>
					<ul className="fcc-certificate_list">
						<li>
							Tribute Page
							<a
								href="https://codepen.io/adrianwix/pen/rvNgxy"
								title="Codepen"
							>
						...
						<li>
							Survey Form
							<a
								href="https://codepen.io/adrianwix/pen/mKxWLd"
								title="Codepen"
							>
								<FontAwesomeIcon icon={faCodepen} />
							</a>
						...
						<li>
							...
							<a
								href="https://codepen.io/adrianwix/pen/mKKXdZ"
								title="Codepen"
							>
								<FontAwesomeIcon icon={faCodepen} />
							</a>
						...
						<li>
							...
							<a
								href="https://codepen.io/adrianwix/pen/bKmXym"
								title="Codepen"
							>
								<FontAwesomeIcon icon={faCodepen} />
							</a>
						...
						<li>
							...
							<a
								href="https://codepen.io/adrianwix/pen/pKGgKL"
								title="Codepen"
							>
								<FontAwesomeIcon icon={faCodepen} />
							</a>
				...
				<div className="fcc-certificate">
					...
					<p className="fcc-certificate_description">
						JavaScript programming language to give functionality to
						websites
					</p>
					<ul className="fcc-certificate_list">
						<li>
				...
				<div className="fcc-certificate">
					...
					<p className="fcc-certificate_description">
						Building Websites with Front End Frameworks and
						Libraries. Specially Bootstrap, jQuery, Sass, React and
					...
					<ul className="fcc-certificate_list">
						...
						<li>
							Pomodoro Clock
							<a
								href="https://codepen.io/adrianwix/full/ZoVdJd/"
								title="Codepen"
							>
								<FontAwesomeIcon icon={faCodepen} />
							</a>
			...
			<Col lg={6}>
				<div className="fcc-certificate">
					...
					<ul className="fcc-certificate_list">
						<li>
							...
							<a
								href="https://codepen.io/adrianwix/full/zJpKeJ"
								title="Codepen"
							>
								<FontAwesomeIcon icon={faCodepen} />
							</a>
						...
						<li>
							...
							<a
								href="https://codepen.io/adrianwix/full/bmBywM"
								title="Codepen"
							>
								<FontAwesomeIcon icon={faCodepen} />
							</a>
						...
						<li>
							...
							<a
								href="https://codepen.io/adrianwix/full/YJZXRV"
								title="Codepen"
							>
								<FontAwesomeIcon icon={faCodepen} />
							</a>
						...
						<li>
							...
							<a
								href="https://codepen.io/adrianwix/full/MzGrvZ"
								title="Codepen"
							>
								<FontAwesomeIcon icon={faCodepen} />
							</a>
						...
						<li>
							...
							<a
								href="https://codepen.io/adrianwix/full/PxeXNW"
								title="Codepen"
							>
								<FontAwesomeIcon icon={faCodepen} />
							</a>
				...
				<div className="fcc-certificate">
					...
					<p className="fcc-certificate_description">
						Managing packages with npm. Back-End Development with
						Node.js (Javascript Server-side) and Data storage with
				...
				<div className="fcc-certificate">
					...
					<p className="fcc-certificate_description">
						Adding basic security to websites. Automatic testing
						with Mocha Test Framework. Passport.js for user
						authentication
					</p>
					<ul className="fcc-certificate_list">
						<li>
		...
		<p className="h2-home mb-5">
			To contact me follow me on{' '}
			<a href="https://twitter.com/adrian_wix">Twitter</a> and write to
			me!
		</p>
	</Container>
)
